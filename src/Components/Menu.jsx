  ...
  return (
    <div>
           ...
           <span>Dev-Blogs</span>
            ...
            <Link href="/admin">
            <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-solid border-black rounded hover:bg-black hover:text-white transition delay-100 cursor-pointer' >
                Create A Post
            </button>
            </Link>
        </div>
